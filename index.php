...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-NR54PC7P"
...
<div class="HighLights">
    ...
    <div class="ach">
            ...
            <div class="ac1">
                ...
                <i class="fa fa-check" style="font-size:20px;"></i><h3>19000+ learners</h3>
            </div>
            ...
            <div class="ac1">
                ...
                <h3>2500+ success story</h3>
            </div>

            <div class="ac1">
                <i class="fa fa-trophy" style="font-size:20px;"></i>
                <h3>100% Brand Impact</h3>
            </div>
        </div>
    </div></div>
</div>
...
<!-- 
                  <div class="item">
                    <div class="course_card">
                    <img src="assets/img/emerging-technology.webp" alt="Image 1">
                    <div class="cr-cnt">
                    <h2>Online DBA in Data Science</h2>
                    <p>The DBA in Data Science combines DBA degree programs with cutting-edge analytics, big data, and AI, preparing professionals to lead data-driven business decision-making.
</p>
...
<div class="achievement">
    ...
    <div class="achievement_cnt">
      <div class="ach_C">
        ...
        <div class="ach_C">
                <img src="assets/img/90-essential-tool.webp" alt="90-essential-tool" class="img-responsive">
            </div>
...
<!-- <section id="sample-degree">
   ...
   <center>    <img src="assets/img/sample-certificate.webp" alt="sample-degree" class="img-responsive"></center>
       <div class="degree-info">
           ...
           <h3>HR Analyics Certification Universities</h3><br>
           <p>Complete all Universities modules and earn a professional HR Management and Analytics certification from IIM Kozhikode. This Universities will help you develop important skills for the HR field. It will also boost your career and make you more competitive in the job market.
           </p><br>
...
<section id="advantages" class="career-scope-section">
    ...
    <div class="diagram-container">
        ...
        <!-- Lines connecting the boxes will be done with pseudo-elements in CSS -->
    </div>
</section>
...
<section class="certificate-section">
    ...
    <div class="certificate-column">
        <!-- Placeholder for your certificate image -->
        <img src="assets/img/mica-certificate.webp" alt="mica certificate" class="certificate-img">
    </div>
